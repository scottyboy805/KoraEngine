...
namespace KoraGame.Graphics
{
    ...
    public sealed class Texture : GameElement
    {
        ...
        {
            // Map the upload buffer
            IntPtr ptr = SDL3.SDL_MapGPUTransferBuffer(graphics.gpuDevice, gpuUploadBuffer, false);
        ...
        {            
            ...
            {
                // Map the upload buffer
                ptr = SDL3.SDL_MapGPUTransferBuffer(graphics.gpuDevice, gpuUploadBuffer, false);
            }
        ...
        private unsafe void CreateTexture()
        {
            ...
            this.gpuTexture = SDL3.SDL_CreateGPUTexture(graphics.gpuDevice, &textureInfo);
            ...
            // Create the sampler
            gpuSampler = SDL3.SDL_CreateGPUSampler(graphics.gpuDevice, &samplerCreateInfo);
            ...
            gpuUploadBuffer = SDL3.SDL_CreateGPUTransferBuffer(graphics.gpuDevice, &uploadCreateInfo);
        }
        ...
        private unsafe void DestroyTexture()
        {
            ...
            if (gpuTexture != null)
            {
                SDL3.SDL_ReleaseGPUTexture(graphics.gpuDevice, gpuTexture);
                gpuTexture = null;
            }
            ...
            if (gpuSampler != null)
            {
                SDL3.SDL_ReleaseGPUSampler(graphics.gpuDevice, gpuSampler);
                gpuSampler = null;
            }
