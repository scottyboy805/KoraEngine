...
{
	// Private
	private const int32 fpsAverageSamples = 24; // Average over 60 frames
	...
	public static int32 Frame => frame;
	...
	private static void UpdateFPS(float frameDelta)
	{
	    ...
	    float totalTime = 0f;
	    int32 validSamples = Math.Min(frame, fpsAverageSamples);
