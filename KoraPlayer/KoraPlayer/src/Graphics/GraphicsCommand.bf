...
public struct GraphicsCommand
{
	...
	// Constructor
	internal this(SDL_GPUDevice* gpuDevice, SDL_GPUCommandBuffer* gpuCommandBuffer)
	{
...
#region RenderPass
	public void BeginRenderPass(Color clearColor, Texture renderTarget = null) mut
	{
		...
		if(renderTarget == null)
		{
			...
			SDL_WaitAndAcquireGPUSwapchainTexture(gpuCommandBuffer, null, &target, &width, &height);
