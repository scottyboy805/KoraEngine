...
namespace KoraPlayer_Console;

static
{
	typealias GamePtr = void*;

	// Exports
	[CLink]
	public static extern GamePtr CreateGame();

	[CLink]
	public static extern c_int GameEvent(GamePtr game, SDL3.SDL_Event* evt);

	[CLink]
	public static extern c_int GameIterate(GamePtr game);

	[CLink]
	public static extern void GameQuit(GamePtr game);
}
